...
const Login = () => {
  ...
  const handleSubmission = async (data) => {
    ...
    if (res.success) {
      ...
      dispatch(
        aboutActions.setAbout(
          res.data.profile.about
            ? { description: about.description, slectedTime: about.slectedTime }
            : { description: "", selctedTime: [] }
        )
      );
    } else {
      setError(true);
  ...
  const fbConfig = {
    appId: "244008038508311",
    appSecret: "be60f185d9ea8a2182122c46426bcf9e",
    scope: "email",
  };
            ...
            <div className="bg-white flex      gap-5   rounded-lg border-2  flex-col md:px-16  sm:px-16 md:py-[4.8em] ss:py-[5%] ss:px-[5%]    ss:w-[95%] sm:w-[95%] md:w-[60%] ss:px-15 ss:py-30 ">
              ...
              >
                ...
                <div className="flex flex-row items-center  justify-center gap-5">
                  ...
                  <div className="hover:cursor-pointer" onClick={handleWithFacebook}>
                    <img
