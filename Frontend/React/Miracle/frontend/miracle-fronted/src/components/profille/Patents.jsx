...
const Patents = () => {
  ...
  const patentsInitialValues = useSelector((state) => state.formData.patents);
  ...
  const handleEdit = (itemId) => {
    setEditData(itemId);
    const itemToEdit = patentsInitialValues.find((item) => item.id === itemId);
    setPatent({
      id: itemToEdit.id,
  ...
  const handleDelete = (id) => {
    dispatch(formDataActions.deletePatent({ id: id }));
  };
            ...
            editData == item.id ? (
              <>
                ...
                >
                  ...
                  <div className="flex ss:flex-col w-full ss:gap-6  ">
                    <div className="lex flex-col md:w-6/12  md:block w-full">
                      <label htmlFor="description" className="text-[#555555] ">
                        Description
                      </label>
                      <input
              ...
              <div
                key={item.id}
                className="border-b pl-[5%] py-5 flex flex-col gap-5 "
              >
