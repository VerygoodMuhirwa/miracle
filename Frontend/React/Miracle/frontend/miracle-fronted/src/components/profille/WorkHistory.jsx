    ...
    <div className="h-full sm:px-20 overflow-x-hidden">
      <div className="bg-white ">
        ...
        <div className="flex flex-col  ">
          <div className="flex md:flex-row py-5   ss:px-[5%]   md:justify-between ss:flex-col sm:gap-0 ">
            <div className="flex md:flex-col gap-3 items-center   ss:px-[20%]  md:p-0 ss:flex-row">
            ...
            <div className="flex md:flex-col gap-3 ss:px-[20%] md:p-0 items-center ">
              <p className="text-xl font-bold ">98</p>
              <p>Students</p>
            </div>
            <div className="flex md:flex-col gap-3 sm:items-center  ss:px-[20%] md:p-0 ">
              <p className="text-xl font-bold ">156</p>
              <p>lessons</p>
            </div>
            <div className="flex md:flex-col gap-3 ss:px-[20%] md:p-0 sm:items-center">
              <p className="text-xl font-bold ">100%</p>
              <p>Attendance</p>
            </div>
            <div className="flex md:flex-col gap-3 items-center ss:px-[20%] md:p-0 ">
              <p className="text-xl font-bold ">80%</p>
              <p>Response</p>
            </div>
          </div>
          <div className="flex  items-center  pb-5 ss:px-[20%]  ">
