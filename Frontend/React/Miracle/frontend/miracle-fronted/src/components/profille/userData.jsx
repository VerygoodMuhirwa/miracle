...
const UserData = () => {
  ...
  const [countryCode, setCountryCode] = useState(countryInfo.code); // Updated state for country code
  ...
  const [flagValue, setFlagValue] = useState(countryInfo.flag);
  ...
  return (
    <div className="h-full relative  sm:px-20   overflow-x-auto-hidde" >
      ...
      <div className="absolute ss:top-28 sm:left-[13%] md:left-[10%] ss:left-[10%]  flex flex-row  justify-center items-center">
        <img
          ...
          <>
            <div>
              ...
              <div className="flex flex-col  gap-3 mb-5">
                ...
                <div className="flex flex-col  sm:self-baseline">
