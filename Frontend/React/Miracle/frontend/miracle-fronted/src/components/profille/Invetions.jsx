              ...
              >
                <div className="flex flex-col     ">
                  ...
                  <input
                    type="text"
                    id="title"
                    className="border-2   rounded-md indent-5"
                    required
                ...
                <div className="flex flex-row w-full">
                  <div className=" flex-col md:w-6/12  md:block w-full">
                    ...
                    <input
                      type="text"
                      id="description"
                      className="border-2 w-[70%] indent-5 h-24 rounded-md"
                      required
          ...
          {inititialInvetion.map((item) =>
            editData == item.id ? (
              <>
                ...
                <form
                  key={item.id}
                  className=" flex   ss:flex-col gap-5 py-5    ss:px-2 "
                  ...
                  <div className="flex ss:flex-col w-full ss:gap-6    ">
                    <div className="flex flex-col md:w-6/12  md:block w-full ">
                      ...
                      <input
                        type="text"
                        id="description"
                        className="border-2  h-24 rounded-md indent-5 w-full"
                        required
                        value={invetion.description}
                        onChange={updateDesctiption}
                      />
