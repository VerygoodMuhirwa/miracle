...
const NavBar = () => {
  ...
  return (
    <div >
      <div className="bg-white flex flex-row justify-between items-center  border border-b-1 py-2  overflow-hidden   ">
        <div className="ss:pl-[4%]   sm:pl-[10%] w-full ">  
          <img
        ...
        {isLoggedIn && (
          <>
            <div className="relative ">
              ...
              {showDropdown && (
                <div className="absolute top-[3.4em] right-0 bg-white border border-gray-300 p-4  rounded-lg shadow-md w-48">
                  {/* Dropdown items */}
